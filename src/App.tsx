...
import { Mic, Square, Trash2, Activity } from 'lucide-react';
...
function App() {
  ...
  // Normalize history for visualization (map -60dB...0dB to 0...100 height)
  // Assuming -60dB is silence floor for practical purposes in this visualizer
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col items-center justify-center p-6 md:p-12 font-sans transition-colors duration-500">
      ...
      <h1 className="text-3xl md:text-5xl font-bold mb-2 flex items-center gap-3 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-emerald-400 tracking-tighter">
        <Activity className="text-emerald-400 w-8 h-8 md:w-12 md:h-12" />
        Snore Recorder
      </h1>
      <p className="text-slate-400 mb-12">Monitor your sleep noise levels</p>
